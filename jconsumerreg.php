...
<h3  style="color: white;"> Password * </h3> <input type="password" name="password" placeholder="Enter your Password.." size="30" rows="3" ><br> <br>
<h5 id="d2" style="color: white;"> </h5> <h5 id="d3" style="color: white;" > </h5> <h5 id="d4" style="color: white;"> </h5>  <br>
<h3  style="color: white;"> Confirm Password * </h3> <input type="password" name="passwordconf" placeholder="Re-type your Password.." size="30" rows="3" ><br> <br>
...
<h3  style="color: white;"> Enter your Date of Birth * </h3> <input type="date" name="dob" size="30" rows="3" > <br> <br>
...
<h3  style="color: white;">Home Address *</h3> <input type="text" name="addr" placeholder="Enter your Address.." size="30" rows="3" > <br> <br>
<h3  style="color: white;"> Phone Number *</h3> <input type="text" name="phoneno" placeholder="Enter your Phone number.." size="30" rows="3"> <br> <br><div id="d5" style="color: white;"> </div> 
...
<img id="img">
 <script>
const fileSelector = document.getElementById('profile');
...
else
{
  ...
  $target_file = $target_dir . basename($_FILES["profile"]["name"]);
   ...
   $query=mysqli_query($con,"INSERT INTO iwp_database___user_database(Username, Password, User_Loc_Name,User_Phone,User_Pfp,User_Email)VALUES('$username','$password','$addr','$phoneno','$name','$mail')");
