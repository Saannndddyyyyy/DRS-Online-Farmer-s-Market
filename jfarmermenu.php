...
.navbar {
  ...
  background-color: rgba(66, 63, 52,0.7);
  width: 100%;
}
...
<label for="filter_3" style="cursor: pointer;">All <img src="https://img.icons8.com/offices/45/000000/select-all.png"/> <?php echo "(" .($fru + $veg). ")"; ?></label>
 ...
 <input id="myDate" type="date" style="float: left; margin: 10px; margin-right: 10px; padding:5px;" value="<?php echo date("Y-m-d"); ?>"> </input>
</div>
<script>
...
echo "<div style='margin-left:130px;'>";
     ...
     echo "<a href='jfarmermenu.php?page=".$i."'";
